                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        @if($submission->images->where('approved',1))
                                            <span class="inline-flex rounded-full bg-yellow-300 px-2 text-xs font-semibold leading-5 text-white">{{$submission->images->where('approved',1)->count()}} Approved</span>
                                        @else
