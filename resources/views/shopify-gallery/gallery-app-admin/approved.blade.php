    ...
    <div class="mt-2 px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-3">
            ...
            <div class="col-span-1">
                <div class="mt-1">
                    <input type="text" id="search" class="shadow-sm focus:ring-move-500 focus:border-move-500 block w-full sm:text-sm border-gray-300 px-4 rounded-full" placeholder="Search" value="{{request()->filter || null}}">
                </div>
            </div>
        </div>
            ...
            <div class="hidden sm:block">
                <div class="border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        <a href="/" class="app-link border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">New Submissions</a>
                        <a href="/approved" class="app-link border-move-500 text-move-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">Approved</a>
                    </nav>
                </div>
            </div>
        </div>
