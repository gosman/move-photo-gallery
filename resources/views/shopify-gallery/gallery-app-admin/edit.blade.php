                                        ...
                                        <dl class="mt-1 flex-grow flex flex-col justify-between">
                                            ...
                                            @else
                                                <dd class="mt-3">
                                                    ...
                                                    <a class=" flex justify-center items-center" href="{{config('filesystems.disks.images.cdn')}}{{$image->image_name}}" download>
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"/>
                                                        </svg>
                                                        <span class="stroke-gray-300">Download Original</span>
                                                    </a>
                                                </dd>
                                            @endif
                                        </dl>
