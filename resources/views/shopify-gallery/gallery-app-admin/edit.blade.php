                                        ...
                                        <dl class="mt-1 flex-grow flex flex-col justify-between">
                                            ...
                                            @else
                                                <dd class="mt-3">
                                                    ...
                                                    <a href="{{config('filesystems.disks.images.cdn')}}{{$image->image_name}}" download>
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 justify-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
