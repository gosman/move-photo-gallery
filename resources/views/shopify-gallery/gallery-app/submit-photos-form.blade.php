    ...
    <div class="col-md-12 text-left">
            ...
            <div class="col-lg-4">
                <div class="input-group has-validation mt-2">
                    ...
                    <select class="form-select required" id="uBumperType">
                        ...
                        <option value="Full Grille">Full Grille</option>
        ...
        <form action="/target" class="fileuploader" id="dropzone">
            ...
            <g>
                <g>
                    <g>
                        <path style="fill:#009482;" d="M149.968,50.186c-8.017-14.308-23.796-22.515-40.717-19.813
                    ...
                    <g>
                        <path style="fill:#009482;" d="M108.586,90.201c1.406-1.403,1.406-3.672,0-5.075L88.541,65.078
